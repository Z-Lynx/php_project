<template>
  <div class="flex items-center space-x-3">
    ...
    <div v-if="user !== null" class="relative">
      ...
      <div v-show="isMenuVisible" class="absolute right-0 z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
        <div class="px-4 py-3">
