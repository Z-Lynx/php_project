<!-- <template>
    <div class="container">
     <main>
      <h1 style="font-weight: 700; font-size: larger;">Product Detail</h1>
      ...
      <div class="main-container">
       ...
       <div class="main-container__box-two">
        ...
        <div class="sub-container__box-two">
         ...
         <div>
          <k-button class="filled bg-[#D9D9D9] ">Add to Cart</k-button>
         </div>
        </div>
        <!-- <Cart /> -->
   ...
   * {
   ...
   <template>
    <div class="container mx-auto mt-10">
      <div class="flex">
        <div class="w-3/4">
          <img :src="require(`@/assets/${product.image}`)" alt="Product Image" class="w-full" />
        </div>
        <div class="w-1/4 ml-4">
          <h2 class="text-2xl font-bold mb-4">{{ product.name }}</h2>
          <p class="text-gray-600">{{ product.description }}</p>
          <div class="mt-4">
            <span class="text-orange-500 font-semibold">{{ product.price }} đ</span>
          </div>
          <button class="mt-4 bg-gray-500 text-orange-500 p-2">Buy</button>
        </div>
      </div>
    </div>
  </template>
